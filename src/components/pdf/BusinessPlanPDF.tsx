    ...
    <Document>
      ...
      <Page size="A4" style={styles.coverPage}>
        ...
        <View style={styles.coverBody}>
          ...
          <Text style={styles.coverHighlight}>
            Validated by Curatos DNA - the intelligent business idea validator.
          </Text>
          <Text style={styles.coverBrand}>Generated by Curatos DNA | curatos.io</Text>
        </View>
      </Page>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Curatos DNA - Business Plan</Text>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>Generated by Curatos DNA | {today}</Text>
          ...
          <View style={styles.chartsContainer}>
            {pieChartImage && (
              <View style={styles.chartBox}>
                ...
                <Image style={styles.chartImage} src={pieChartImage} />
              </View>
            )}
            {barChartImage && (
              <View style={styles.chartBox}>
                <Text style={styles.chartTitle}>Revenue Projections</Text>
                <Image style={styles.chartImage} src={barChartImage} />
              </View>
            )}
          </View>
        )}
