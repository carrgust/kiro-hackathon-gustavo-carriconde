...
function SourceCard({ source, onRemove }: SourceCardProps) {
  ...
  const renderThumbnail = () => {
    ...
    if (isReddit) {
      ...
      return (
        <div className="w-full h-full bg-gradient-to-br from-orange-600 to-red-600 flex flex-col items-center justify-center text-white rounded-lg">
    ...
    if (isHN) {
      ...
      return (
        <div className="w-full h-full bg-gradient-to-br from-orange-500 to-orange-600 flex flex-col items-center justify-center text-white rounded-lg">
