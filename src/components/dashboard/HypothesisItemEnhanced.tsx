...
const HypothesisItemEnhanced = memo(function HypothesisItemEnhanced({ 
  ...
  return (
    <motion.article
      ...
      whileTap={{ scale: 0.98 }}
      className={`group relative overflow-hidden tb-card bg-gradient-to-br ${config.bgGradient} backdrop-blur-sm rounded-lg ${config.glow} transition-all duration-300 cursor-pointer focus-within:ring-2 focus-within:ring-cyan-500`}
      onClick={onClick}
