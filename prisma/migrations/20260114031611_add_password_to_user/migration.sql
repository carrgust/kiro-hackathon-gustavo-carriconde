...
CREATE TABLE "Research" (
    ...
    "userId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "inputIdea" TEXT NOT NULL,
    "status" TEXT NOT NULL DEFAULT 'pending',
    "currentEngine" INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_researchId_fkey" FOREIGN KEY ("researchId") REFERENCES "Research"("id") ON DELETE SET NULL ON UPDATE CASCADE;
